...
# Control how many San Jose ZIP codes are processed (default: 5)
python harvester.py --type pre_foreclosure --zip-limit 10
...
The workflow file is already included at `.github/workflows/harvest.yml`.  
Add your secrets in GitHub → Settings → Secrets and variables → Actions:
- `SUPABASE_URL`
- `SUPABASE_SERVICE_KEY`
- `ATTOM_API_KEY`

The harvester will then run automatically every Monday at 6 am PT.
